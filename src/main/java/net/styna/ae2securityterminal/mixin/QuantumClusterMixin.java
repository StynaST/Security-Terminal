...
public abstract class QuantumClusterMixin {
    @WrapOperation(method = "updateStatus", at = @At(value = "INVOKE", target = "Lappeng/api/networking/GridHelper;createConnection(Lappeng/api/networking/IGridNode;Lappeng/api/networking/IGridNode;)Lappeng/api/networking/IGridConnection;"))
